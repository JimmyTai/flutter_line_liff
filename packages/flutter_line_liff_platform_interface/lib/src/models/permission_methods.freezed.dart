...
part of 'permission_methods.dart';
...
mixin _$PermissionStatus {
  PermissionState get state => throw _privateConstructorUsedError;
...
abstract class $PermissionStatusCopyWith<$Res> {
  ...
  @useResult
  $Res call({PermissionState state});
}
...
class _$PermissionStatusImpl implements _PermissionStatus {
  const _$PermissionStatusImpl({required this.state});
  ...
  @override
  String toString() {
    return 'PermissionStatus(state: $state)';
  }
...
abstract class _PermissionStatus implements PermissionStatus {
  const factory _PermissionStatus({required final PermissionState state}) =
